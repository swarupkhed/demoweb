...
public class post {
    ...
    public post(String ptitle, String pcontent, String pcode, Object object, int catid, int id) {
     ...
     * @param id
     */
    public post(String ptitle, String pcontent, String pcode, int catid, int id) {
